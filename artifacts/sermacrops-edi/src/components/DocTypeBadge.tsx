...
const DOC_COLORS: Record<string, string> = {
  ...
  "846": "bg-orange-100 text-orange-700 dark:bg-orange-900/40 dark:text-orange-400",
  "861": "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-400",
